            ...
            if (!(plugin.settings.always_visible instanceof jQuery)) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        if ($element.css('display') === 'block') icon_wrapper.css('width', "200px");//$element.outerWidth(true)
                ...
                if (undefined !== icon) {
                    ...
                    icon.css('top', (element_height - icon_height) / 3);//原来是2
                ...
                if (regexp.length) {
                    ...
                    if ((segments = regexp.exec(str_date))) {
                        ...
                        var tmpdate = new Date(),
                            ...
                            english_months = ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'],
                            iterable,
